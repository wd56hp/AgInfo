#!/bin/bash
# Run discover_bid_pages.py in a Python Docker container
# This script discovers bid pages on company/facility websites
...
echo "AgInfo Bid Page Discovery"
echo "=========================="
...
docker run --rm \
    ...
    sh -c "
        ...
        python discover_bid_pages.py $PYTHON_ARGS
    "
