#!/bin/bash
# Run tests for merg_duplicates.py in a Python Docker container
...
# Read .env file values if it exists
...
echo "Running tests for merg_duplicates.py"
echo "===================================="
echo ""
...
docker run --rm \
    ...
    sh -c "
        ...
        python3 test_merg_duplicates.py
    "
