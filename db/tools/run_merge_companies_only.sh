#!/bin/bash
# Run merge_companies_only.py in a Python Docker container
...
echo "AgInfo Company Merger (Companies Only)"
echo "======================================="
...
docker run --rm \
    ...
    sh -c "
        ...
        python3 merge_companies_only.py ${PYTHON_ARGS}
    "

echo ""
echo "Company merge complete!"
